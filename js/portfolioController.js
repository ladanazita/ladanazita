...
var filterGroups = ['completion', 'type', 'participation'];

/** The Work template */
var workTemplate =  [
          '<a href="{{#link}}{{href}}{{/link}}" title="{{#link}}{{value}}{{/link}}" target="_blank" data-id="{{id}}" class="work completion:{{completion}} type:{{type}} participation:{{participation}}">',
